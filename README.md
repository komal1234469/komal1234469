...
🌱 Practicing **DSA with C++ and Python**  
📊 Learning **Power BI Desktop for Data Visualization**  
🚀 Improving my **problem-solving and programming skills**

---

## 🎓 Education
- **B.Tech (Computer Science Engineering)** – Maharana Pratap Institute of Professional Studies, Kanpur *(Top 10 in Class)*
- **Class XII (2023)** – 67.5% | Uttar Pradesh Board
- **Class X (2021)** – 83.17% | Uttar Pradesh Board
...
- IBM – Data Visualization with Python (2024)
- NIELIT – Course of Computer Concepts (2023)
- Simplilearn – Data Analyst 101 (2025)
- Simplilearn – Basics of Data Structures & Algorithms (2025)
- Forage – Quantitative Research Job Simulation (J.P. Morgan, 2025)
- Forage – GenAI Powered Data Analytics Job Simulation (TCS, 2025)
...
- National Children’s Science Conference (2021) – Participant
- Participated in multiple coding challenges & tech quizzes
- Completed **5-Day AI Agents Intensive Course with Google**
